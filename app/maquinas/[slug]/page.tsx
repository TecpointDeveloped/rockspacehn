      ...
      <section className="product-hero-v2">
        <div className="shell product-hero-v2-grid">
          <div className="product-hero-copy">
            ...
            <div className="button-row"><a className="button button-white" href={whatsappUrlFor(cms.support.salesWhatsappNumber, `Hola, quiero información y disponibilidad de la ${machine.name}.`)} target="_blank" rel="noreferrer">Consultar disponibilidad</a><a className="button button-ghost-light" href="#tutorial">Ver cómo funciona</a></div>
          </div>
